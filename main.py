...
def parse_args():
    ...
    parser.add_argument('--context_model', type=str, default='resnet50', choices=['resnet18', 'resnet50'], help='context model type')
    parser.add_argument('--body_model', type=str, default='resnet50', choices=['resnet18', 'resnet50'], help='body model type')
    ...
    parser.add_argument('--filter_col', type=str, default=None, help='annotated column')
    parser.add_argument('--filter_val', type=str, default=None, help='annotated value')
    # Generate args
